package com.example.colectivos_interurbanos_aguilar.services;
...
import com.example.colectivos_interurbanos_aguilar.activities.driver.NotificationBookingActivity;
import com.example.colectivos_interurbanos_aguilar.channel.NotificationHelper;
import com.example.colectivos_interurbanos_aguilar.receivers.AcceptReceiver;
import com.example.colectivos_interurbanos_aguilar.receivers.CancelReceivers;
...
public class MyFirebaseMessagingClient extends FirebaseMessagingService {
    ...
    private void showNotificationActions(String title, String body, String idClient) {
        ...
        NotificationCompat.Action accepAction = new NotificationCompat.Action.Builder(
        ...
        //action cancelar
        Intent cancelIntent = new Intent(this, CancelReceivers.class);
        ...
        Uri sound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        NotificationHelper notificationHelper = new NotificationHelper(getBaseContext());
        NotificationCompat.Builder builder = notificationHelper.getNotificationOldAPIActions(title, body, sound, accepAction, cancelAction);
    ...
    private void showNotificationApiOreoActions(String title, String body, String idClient) {
        ...
        Notification.Action accepAction = new Notification.Action.Builder(
                R.mipmap.ic_launcher,
                "Aceptar",
                acceptPendingIntent
        ).build();
        ...
        Uri sound = RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION);
        NotificationHelper notificationHelper = new NotificationHelper(getBaseContext());
        Notification.Builder builder = notificationHelper.getNotificationActions(title, body, sound, accepAction, cancelAction);
        notificationHelper.getManager().notify(2, builder.build());
